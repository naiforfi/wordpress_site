        ...
        'title_area' => array(
            ...
            'layout'    => array(
                ...
                'disable_title_mobile' => array(
                    'default'   => false,
                    'type'      => 'checkbox',
                    'label'     => esc_html_x('Disable Title Area for Mobile Devices', 'customizer', 'setech'),
                ),
        ...
        'sticky_menu_section' => array(
            ...
            'layout'    => array(
                ...
                'custom_sticky' => array(
                    ...
                    'default'       => 'default',
                    'choices'       => array(
                        'default'   => esc_html_x('Use Customizer Settings', 'customizer', 'setech'),
                        'disable'   => esc_html_x('Disable Sticky Menu', 'customizer', 'setech'),
