...
function nasa_wpb_watch() {
    return array(
        'post' => array(
            'post_content' => '[vc_row fullwidth="1" el_class="margin-bottom-30"][vc_column][rev_slider alias="slider-02-1-1"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][nasa_banner align="center" valign="middle" text-align="text-center" hover="zoom" img_src="3117"]
