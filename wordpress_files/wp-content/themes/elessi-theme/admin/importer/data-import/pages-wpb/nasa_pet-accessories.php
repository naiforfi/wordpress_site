...
function nasa_wpb_pet_accessories() {
    return array(
        'post' => array(
            'post_content' => '[vc_row fullwidth="1" el_class="margin-bottom-50"][vc_column][rev_slider slidertitle="Slider Pet Accessories" alias="slider-pet-accessories"][/vc_column][/vc_row][vc_row el_class="margin-bottom-30"][vc_column][nasa_title title_text="Featured Categories" title_type="h2" title_desc="The freshest and most exciting news" title_align="text-center"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][nasa_banner valign="bottom" hover="zoom" img_src="3094"]
...
[/nasa_banner][/vc_column][/vc_row][vc_row][vc_column][nasa_title title_text="Latest Blogs" title_type="h1" title_bg="#ffffff" title_desc="The freshest and most exciting news" title_align="text-center" el_class="margin-top-30 mobile-margin-top-50"][nasa_post arrows="1" posts="4" columns_number="3" columns_number_small_slider="1" columns_number_tablet="2" date_enable="no" author_enable="no" page_blogs="no" el_class="desktop-margin-bottom-80"][/vc_column][/vc_row]',
